...
function Object() {
    ...
    if ($[0] !== "5909380959ac57d8759769c1d7bf776f52e76d0e297141f37738d660c6014517") {
        for(let $i = 0; $i < 9; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "5909380959ac57d8759769c1d7bf776f52e76d0e297141f37738d660c6014517";
    }
    ...
    if ($[1] !== params.id) {
        t0 = ({
            "Object[useEffect()]": ()=>{
                fetch(`https://ambilux.com/api/objects/${params.id}`).then(_ObjectUseEffectAnonymous).then({
